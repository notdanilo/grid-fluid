...
impl Simulator {
    ...
    pub fn simulate(&mut self, fluid: &mut Fluid, delta_time: f32) {
        ...
        self.advector.advect(&mut fluid.velocity_field, &fluid.previous_velocity_field, &fluid.previous_velocity_field);
        self.projector.project(&mut fluid.velocity_field, &mut fluid.previous_velocity_field, iterations);
        self.advector.advect(&mut fluid.density_field, &fluid.previous_density_field, &fluid.velocity_field);
    }
}